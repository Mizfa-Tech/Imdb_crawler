...
class ImdbSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):
        ...
        country_of_origin = response.xpath('/html/body/div[2]/main/div/section[1]/div/section/div/div[1]/section[12]/div[2]/ul/li[2]/div/ul/li/a/text()').get()
        ...
        yield {'title':title,"language":language,'casts':casts,'date':date,'cover_url':cover_url,'genres':genres,'description':description,'creator':creator,'country_of_origin':country_of_origin}
